        ...
        <div class="container">
          ...
          <div v-if="isInitProject">
            ...
            <div id="mobile" :style="getStyleMobile()"
                 :class="(data.pages.length < 1?'inactive':'blurable')+(currentDisplay.borderLess?' borderless':'')+' '+currentDisplay.camera+' '+currentDisplay.cameraBorder">
    ...
    getStyleCamera: function () {
      ...
      if (this.currentDisplay.camera == 'type1') {
        if (this.currentDisplay.cameraBorder == '') {
          ...
          style += 'left: calc( 50% - ' + (130 * this.display.scale / 2) + 'px);';
        ...
        if (this.currentDisplay.cameraBorder == 'cb2') {
          style += 'left: 25%;';
          style += 'top:0;';
          style += 'width:auto;';
